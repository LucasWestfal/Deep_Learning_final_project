...
def loss_function(model, alpha, x_init, y_init, t_init, u_init, x_boundary,
    ...
    return loss, mse_initial, mse_boundary, mse_pde
...
def main():
    ...
    columns = ["n_hidden_layers", "hidden_size", "epochs", "data_size", "train_loss", "val_loss", "val_loss_initial_data", "val_loss_boundary_data", "val_loss_collocation", "elapsed_time"]
